...
{
	memmove_s(m_shipArray, sizeof(int [_SHIP_ARRAY_INDEX_][_SHIP_ARRAY_INDEX_]),
				_pCShip->m_shipArray, sizeof(int [_SHIP_ARRAY_INDEX_][_SHIP_ARRAY_INDEX_]));
	memmove_s(m_actionArray, sizeof(int [_SHIP_ARRAY_INDEX_][_SHIP_ARRAY_INDEX_]),
				_pCShip->m_actionArray, sizeof(int [_SHIP_ARRAY_INDEX_][_SHIP_ARRAY_INDEX_]));
	memmove_s(m_searchArray, sizeof(int [_SHIP_ARRAY_INDEX_][_SHIP_ARRAY_INDEX_]),
				_pCShip->m_searchArray, sizeof(int [_SHIP_ARRAY_INDEX_][_SHIP_ARRAY_INDEX_]));
	memmove_s(m_moveArray, sizeof(int [_SHIP_ARRAY_INDEX_][_SHIP_ARRAY_INDEX_]),
				_pCShip->m_moveArray, sizeof(int [_SHIP_ARRAY_INDEX_][_SHIP_ARRAY_INDEX_]));
	
	m_userID	= _pCShip->m_userID;
	m_posColumn	= _pCShip->m_posColumn;
	m_posLine	= _pCShip->m_posLine;
}