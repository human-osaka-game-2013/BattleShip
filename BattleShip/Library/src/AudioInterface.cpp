...
void Audio::LoadAllSoundFile()
{
	...
	LoadSoundFile( "../BattleShip/sound/torpedo.wav",		_TORPEDO_SE_ );
	...
	LoadSoundFile( "../BattleShip/sound/click_1.wav",		_CLICK_SE_ );
	LoadSoundFile( "../BattleShip/sound/click_2.wav",		_FAILED_SE_ );
